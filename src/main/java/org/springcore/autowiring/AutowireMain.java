...
public class AutowireMain {
     public static void main(String args[]){
         ...
         ConfigurableApplicationContext configurableApplicationContext1 = new ClassPathXmlApplicationContext("file:src/main/java/org/springcore/autowiring/config.xml");
